...
import { ObservabilityV2View } from './components/observability-v2';
...
type TabId = 'workstreams' | 'agent-graph' | 'events' | 'observability-v2';
...
export const App: React.FC = () => {
  ...
  const tabs: { id: TabId; label: string; icon: string }[] = [
    ...
    { id: 'observability-v2', label: 'Observability v2', icon: '🔬' },
  ];
  ...
  // Events tab is full-screen dark
  if (activeTab === 'events') {
    return (
      <div className="flex h-screen flex-col bg-slate-950 text-slate-100">
        <header className="sticky top-0 z-10 flex items-center gap-4 border-b border-slate-800 bg-slate-950/95 px-4 py-2 backdrop-blur">
  ...
  // Observability v2 tab is full-screen dark
  if (activeTab === 'observability-v2') {
    return (
      <div className="flex h-screen flex-col bg-slate-950 text-slate-100">
        <header className="sticky top-0 z-10 flex items-center gap-4 border-b border-slate-800 bg-slate-950/95 px-4 py-2 backdrop-blur">
          <h1 className="text-lg font-bold text-slate-200">Holocene</h1>
